  ...
  <div class="container mx-auto flex flex-col items-center py-12 sm:py-24">
    ...
    <div class="flex justify-center items-center">
      <router-link to="/todos">
        <button
          class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 bg-blue-500 transition duration-150 ease-in-out hover:bg-blue-600 lg:text-xl lg:font-bold rounded text-white px-4 sm:px-10 border border-blue-500 py-2 sm:py-4 text-sm"
        >
          Page Todo
        </button>
      </router-link>
